...
sub showHelp() {
    ...
    print "This utility thresholds a target term list by removing any terms\n";
    print "with IC less than the threshold provided. Uses the target term\n";
    print "list, icpropogation file, and threshold provided as input\n";
    print "NOTE: any CUI that does not occur in the IC file will NOT\n";
    print "be eliminated\n";
    print "\n";

    print "usage: perl applyICThreshold.pl -termFile=<termFile> -icFile=<icFile> -outputFile=<outputFile> -threshold=<threshold>\n";
    ...
    print "             applied\n";
    print "threshold = the IC threshold to apply. Any terms with an IC \n";
    print "            greater than the threshold are eliminated. Threshold\n";
    print "            must be greater than 0 and less than 1\n";
